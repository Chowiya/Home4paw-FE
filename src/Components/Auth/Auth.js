...
const Auth = () => {
  ...
  const hanleGenOtp = async (event) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_URL}/api/genotp`, {
        method: 'POST',
  ...
  const handleForget = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_URL}/api/verifyotp`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const hanleForgotOtp = async (event) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_URL}/api/forgototp`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const updatePassword = async (e) => {
    ...
    e.preventDefault()
    try {
      const response = await fetch(`${process.env.REACT_APP_URL}/update-password`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
