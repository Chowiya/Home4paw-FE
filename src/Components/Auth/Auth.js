...
const Auth = () => {
  ...
  const hanleGenOtp = async (event) => {
    ...
    try {
      const response = await fetch(`${process.env.API_URL}/api/genotp`, {
        method: 'POST',
  ...
  const handleForget = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.API_URL}/api/verifyotp`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const hanleForgotOtp = async (event) => {
    ...
    try {
      const response = await fetch(`${process.env.API_URL}/api/forgototp`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
